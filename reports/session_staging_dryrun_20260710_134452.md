# Session Extraction Staging — dryrun — 2026-07-10 13:44
...
- mode: **dryrun** / exit=0 / analysis_run_id=`2026-07-10T13:44:52_session_extract_staging`

## 候補: 2 outing (insert対象 2 / FAIL隔離 0 / skip 0 / queue未マッチ 0)

| base | session | run_id | laps | best(valid) | gate | checks |
|---|---|---|---:|---:|:--:|---|
| FP-JA52-01 | FP | PROV_20260710_ROUND8_DONINGTONPARK_FP_JA52_R1 | 15 | 90.24 | PASS | all PASS |
| FP-JA52-02 | FP | PROV_20260710_ROUND8_DONINGTONPARK_FP_JA52_R2 | 6 | 89.96 | WARNING | stage_phase22_fill=WARNING |
