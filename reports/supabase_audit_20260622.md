...
|---|---:|---:|---:|---:|---:|---:|
| race_results | 792 | 792 | 792 | 0 | 0 | 1.00 |
...
- local 投影行(raw): 792 / dedup 後キー: 792
- remote uniq キー: 792 / remote 総数(header): 792
...
- remote_extra 合計: 24（cleanup 提案 = `cleanup_proposal_20260622.sql`）
