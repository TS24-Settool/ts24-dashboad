# Session Extraction Staging — dryrun — 2026-07-11 16:45
...
- mode: **dryrun** / exit=2 / analysis_run_id=`2026-07-11T16:45:27_session_extract_staging`

## 候補: 10 outing (insert対象 6 / FAIL隔離 4 / skip 0 / queue未マッチ 0)
...
## 予定/実施 行数: runs_provisional=6 / laps_provisional=44 / lap_suspension_provisional=44
...
- laps_provisional: 66 → 66
- lap_suspension_provisional: 66 → 66
